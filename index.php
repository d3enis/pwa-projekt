...
<body>
    ...
    <main>
        ...
        <section class="news-section">
            ...
            <div class="news-grid">
                <?php
                $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='us' ORDER BY id DESC LIMIT 4";
        ...
        <section class="news-section">
            ...
            <div class="news-grid">
                <?php
                $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='world' ORDER BY id DESC LIMIT 4";
                $result = mysqli_query($dbc, $query);
                $i = 0;
                while ($row = mysqli_fetch_array($result)) {
                    echo '<article>';
